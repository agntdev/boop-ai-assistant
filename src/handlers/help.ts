...
const HELP =
  ...
  "• Ask a question for a web-backed answer\n" +
  "• Remember a private or shared note\n" +
  "• Create a reminder\n" +
  "• Change the model or my instructions from the menu\n\n" +
  "Tap /start whenever you want the menu.";
